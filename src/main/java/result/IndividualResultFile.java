...
public class IndividualResultFile extends ResultXLSXFile {
    public IndividualResultFile(String root, String country) {
        super(root, country, ResultFileType.INDIVIDUAL);
    }
    ...
    protected void fillRow(Row row, String companyName, String securityName, String shareholderName, Double percentOwned, String irLink) {
        ...
        this.getCurrentCell(row).setCellValue(irLink);
    ...
    protected String[] getTableHeaders() {
        return new String[] {"Company name", "Security name", "Shareholder name", "% owned", "IR Link", "Analysis result", "Supporting link"};
    }
}
